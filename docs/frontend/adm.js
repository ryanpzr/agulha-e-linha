document.addEventListener('DOMContentLoaded', function () {
    ...
    function carregarTodasBonecas() {
        ...
        fetch('agulha-e-linha.up.railway.app/get', {
    ...
    addItemForm.addEventListener('submit', function (event) {
        ...
        if (valorTitulo && valorSubTitulo && valorPreco && valorSubPreco && valorFoto) {
            ...
            fetch('agulha-e-linha.up.railway.app/upload', {
                method: 'POST',
    ...
    function criarElementoBoneca(boneca) {
        ...
        const imageUrl = `agulha-e-linha.up.railway.app/imagem/${boneca.nome}`;
    ...
    document.getElementById("deleteItemForm").addEventListener("submit", function (event) {
        ...
        fetch('agulha-e-linha.up.railway.app/delete', {
            method: "DELETE",
            headers: {
